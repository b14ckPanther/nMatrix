  ...
  return (
    <main className='min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white scroll-smooth'>
      ...
      >
        ...
        >
          A living website that adapts, critiques, and redesigns itself.<br />Powered by AI — always evolving, never static.
        </motion.p>
      </section>
      ...
      <section id='about' className='px-12 py-32 text-center'>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          <span className='text-emerald-400 font-semibold'>nMatrix</span> is not just a site — it’s an evolving digital entity. Designed by 
          <span className='font-semibold text-emerald-400'>nmProfessor</span>, it pushes the boundaries of design, intelligence, and creativity on the web.
        </motion.p>
        <img
      ...
      <section id='contact' className='px-12 py-32 text-center bg-gray-800/30'>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Have ideas, feedback, or just curious to connect? Reach out and be part of the evolution.
        </motion.p>
      ...
      <footer className='flex flex-col items-center justify-center text-center py-12 border-t border-gray-700/50'>
        ...
        >
          © {new Date().getFullYear()} nmProfessor.<br />All rights reserved.
        </p>
      </footer>
    </main>
  );
